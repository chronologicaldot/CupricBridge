...
#include <irrlicht.h>
#include <gui/GUIDropdownSelectorFactory.h>
...
int main() {
	...
	irr::gui::GUIDropdownSelectorFactory  dropdownFactory(guiEnvironment);
	guiEnvironment->registerGUIElementFactory(&dropdownFactory);
